...
class TransportIconService {
	...
	/**
	 * Helper pro převod SVG na base64 data URI pro PDF
	 */
	private function wrapSvgForPdf( string $svg, int $width, int $height ): string {
	 ...
	 * Autobus/MHD ikona
	 */
	private function getBusIcon( int $size, bool $forPdf = false ): string {
		$width = round( $size * 1.7 );

		$svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 16">
					<circle fill="#000" cx="6.737" cy="12.873" r="2.794"/>
					<circle fill="#000" cx="23.458" cy="12.873" r="2.794"/>
					<path fill="#000" d="M2.909,12.875l-2.918,-0c-0,-0 0.019,-8.987 -0,-11.051c-0.009,-0.892 0.363,-1.411 1.066,-1.443c2.429,-0.109 25.689,0 25.689,0c-0,0 0.491,0.11 0.875,0.878c0.445,0.89 1.724,3.349 2.213,4.228c0.161,0.289 0.175,0.995 0.175,0.995l0,6.393l-2.77,-0l-0,-0.002c-0,-2.1 -1.705,-3.804 -3.805,-3.804c-2.099,-0 -3.804,1.704 -3.804,3.804l0,0.002l-9.112,-0l-0,-0.002c-0,-2.1 -1.705,-3.804 -3.804,-3.804c-2.1,-0 -3.805,1.704 -3.805,3.804l0,0.002Zm23.608,-10.936l-3.686,-0l0,4.164l5.736,0l-2.05,-4.164Zm-19.063,-0l-6.091,-0l0,3.911l6.091,-0l-0,-3.911Zm7.156,-0l-6.091,-0l0,3.911l6.091,-0l-0,-3.911Zm7.156,-0l-6.091,-0l0,3.911l6.091,-0l-0,-3.911Z"/>
				</svg>';

		return $forPdf ? $this->wrapSvgForPdf($svg, $width, $size) : '<svg width="' . $width . '" height="' . $size . '" viewBox="0 0 30 16" style="fill: currentColor;">' . substr($svg, strpos($svg, '>') + 1);
	}

	/**
	 * Vlak/ŽST ikona
	 */
	private function getTrainIcon( int $size, bool $forPdf = false ): string {
		$width = round( $size * 1.7 );

		$svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 16">
					<path fill="#000" d="M25.162,12.904l-6.052,0c-0.071,-1.527 -1.333,-2.745 -2.878,-2.745c-1.544,-0 -2.807,1.218 -2.878,2.745l-1.574,0c-0.071,-1.527 -1.333,-2.745 -2.877,-2.745c-1.287,-0 -2.377,0.844 -2.747,2.009c-0.074,0.234 -0.247,0.736 -0.247,0.736l0,1.703l-1.18,0l-0,-0.926l-2.412,-0.001l-0.002,-10.676l-2.326,0l0,-2.252l9.417,0l-0,2.622l6.018,-0l-0,-2.549l2.237,0l-0,2.549l6.493,-0l-0,-3.444l3.051,0l0,3.444l1.012,-0l-0,0.53l0.908,0l0,5.985l-0.908,0l-0,1.563l1.794,0l-0,1.452l-3.659,0l-0,2.142l-1.19,0l-0,-2.142Zm-16.654,-9.965l-5.09,-0l0,3.074l5.09,0l-0,-3.074Z"/>
					<circle fill="#000" cx="8.871" cy="13.36" r="2.492"/>
					<circle fill="#000" cx="16.252" cy="13.36" r="2.492"/>
					<circle fill="#000" cx="23.207" cy="14.587" r="1.483"/>
					<circle fill="#000" cx="28.293" cy="14.587" r="1.483"/>
				</svg>';
	 ...
	 * Parkoviště ikona
	 */
	private function getParkIcon( int $size, bool $forPdf = false ): string {
		$svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
	 ...
	 * @param bool   $hideIcon Skrýt ikony (pouze odstranit &TAG)
	 * @param bool   $forPdf   Generovat PDF-kompatibilní SVG (base64)
	 *
