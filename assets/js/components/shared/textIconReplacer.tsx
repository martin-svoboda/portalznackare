...
const iconMap: Record<string, (size: number) => React.ReactElement> = {
	...
	'MHD': (size) => <BusIcon size={size}/>,
	'ŽST': (size) => <TrainIcon size={size}/>,
	'TRAM': (size) => <TramIcon size={size}/>,
	'LAN': (size) => <LanIcon size={size}/>,
	'KAB': (size) => <KabIcon size={size}/>,
